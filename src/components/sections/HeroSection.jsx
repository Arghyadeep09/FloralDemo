    ...
    <>
      <div className="bg-[url('/images/homePlant.jpg')] bg-cover bg-center w-full ">
        <div className="max-w-screen-2xl w-full mx-auto">
          ...
          {/*Top section*/}
          <div className="  flex flex-col gap-[50px] md:gap-0 md:flex-row items-start md:justify-between ">
            <div className="flex flex-col gap-[130px] md:gap-[173px]">
              <div className="w-full max-w-[300px] md:max-w-[802px] ml-5 md:ml-[39px] mt-[120px] md:mt-[147px] ">
                <h2 className="text-[44px] md:text-[118px] font-semibold font-['Inter'] text-[#ffffff]  opacity-75 ">
                  Earth’s Exhale
                </h2>
                <p className=" text-[15px] md:text-[23px] font-medium leading-4 md:leading-[100%] tracking-[0%] text-[#ffffff] opacity-75 ">
                ...
                <div className="flex items-center  gap-[21px] mt-[15px]">
                  ...
                  <span>
                    <button className="h-[30px] md:h-[70px] w-[30px] md:w-[70px] border-2 border-[#ffffff] rounded-full relative p-[11px] md:p-[18px] opacity-75  ">
                      <img
                        src="/images/Polygon 2.svg"
                        alt="play button"
                        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[11px] md:w-[34px] h-[11px] md:h-[34px] filter brightness-0 invert opacity-75"
                      />
                    </button>
                  </span>{" "}
                  <span
                    className="text-[#ffffff] 
                opacity-75 font-['Indie_Flower'] text-[14px] md:text-[25px]"
                  >
                    Live Demo...
                  </span>
                </div>
